...
public class Memoria {
    ...
    */
    ...
    /**
     * Actualiza el BCP del proceso que se acaba de finalizar, marcándolo como finalizado y registrando su tiempo de finalización. Se llama cada vez que se finaliza un proceso para mantener la información actualizada en memoria del sistema.
     * @param bcp
     */
    ...
    /**
     * Carga un conjunto de instrucciones en la zona de usuario de la memoria. Si hay suficiente espacio, las instrucciones se cargan y se retorna un arreglo con la dirección base y el límite asignados.
     * @param instrucciones
     * @return
     */
    ...
    /**
     * Actualiza las direcciones base, límite y PC de los BCPs en memoria del sistema después de compactar la zona de usuario, ajustando las direcciones de los procesos que estaban por encima del espacio liberado para reflejar su nueva posición en memoria. Se llama cada vez que se finaliza un proceso para mantener la información actualizada en memoria del sistema.
     * @param baseLiberada
    ...
    /**
     * Obtiene una lista de todos los BCPs actualmente almacenados en la memoria del sistema, leyendo cada bloque de memoria reservado para un BCP y construyendo objetos BCP con la información almacenada. 
     * @return
     */
